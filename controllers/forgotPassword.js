      ...
      if (result.length > 0) {
        ...
        let mailOption = {
          ...
          html: `<h1>Reset Password</h1><br><hr>
                    ...
                    <a href="https://aresta17.com/reset-password/?verify=${token}">reset-account</a>`,
        };
        ...
        transporter.sendMail(mailOption, (err, info) => {
          if (err) {
            ...
            return res.send(
              `<h1 style="margin:50px auto;padding: 10px;width:80%;background-color: #0db02b;color:white;text-align:center;border-radius:10px;">Link untuk reset akun sudah dikirim ke Email anda</h1>`
            );
          }
        });
      } else {
