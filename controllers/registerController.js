...
let createNewUser = async (req, res) => {
  ...
  try {
    ...
    // });
    return res.send(
      `<div style="margin:50px auto;padding: 10px;width:80%;background-color: #0db02b;color:white;text-align:center;border-radius:10px;"><h1>Berhasil Menyelesaikan Tahap 1 pendaftaran.<br>Lanjutkan dengan login melalui link dibawah.</h1><a href="/login" style="color:inherit">Klik disini untuk Login</a></div>`
    );
  } catch (e) {
    req.flash("msg", e);
    return res.redirect("/register");
