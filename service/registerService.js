  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (cekEmail) {
        ...
        //       <a href="https://aresta17.com/verification/?verify=${verify}" style="text-decoration: none;background-color: yellow; display: inline-block;padding: 10px;border-radius: 15px;">Verifikasi Email</a>
        //   </div>`,
        // };
